...
from .serializers import SignupSerializer, LoginSerializer, TutorPasswordChangeSerializer
...
class TutorPasswordChangeView(APIView):
    permission_classes = [permissions.IsAuthenticated]

    def post(self, request, *args, **kwargs):
        serializer = TutorPasswordChangeSerializer(data=request.data)
